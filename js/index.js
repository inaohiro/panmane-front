...
$(function(){
    $("#progressive-circle01").drawPieChart({
        value: 75,
        color: '#00ff33'
    });
    /*
    $("#progressive-circle02").drawPieChart({
        value: 90,
        color: '00ff77'
    });
    $("#progressive-circle03").drawPieChart({
        value: 45,
        color: { red: 0, green: 255, blue: 153 }
    });
    $("#progressive-circle04").drawPieChart({
        value: 60,
        color: '#00ffbb'
    });
    */
 ...
 */
;(function($, undefined) {
    $.fn.drawPieChart = function(options) {
    ...
    var $this = this,
      ...
      settings = $.extend({
        ...
        lightPiesOpacity: .6,//lighten pie's default opacity
